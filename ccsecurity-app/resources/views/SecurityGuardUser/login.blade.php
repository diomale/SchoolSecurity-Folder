...
<head>
    ...
    @vite(['resources/css/SecurityGuardUser/securityguard_style_login.css','resources/js/app.js'])
...
<body>
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('security.login.submit') }}" id="loginForm">
            @csrf
