                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                Great news! The event creator has approved your registration for <strong>{{ $registration->event->event_name }}</strong>.
                                Your QR code is now active and ready to use.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="text-align: center; margin-bottom: 30px;">
                                <tr>
                                    <td>
                                        ...
                                        <div style="display: inline-block; padding: 20px; background-color: #ffffff; border: 2px solid #10b981; border-radius: 8px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #d1fae5; border-left: 4px solid #10b981; border-radius: 4px; padding: 15px; margin-bottom: 20px;">
                                <tr>
                                    <td>
