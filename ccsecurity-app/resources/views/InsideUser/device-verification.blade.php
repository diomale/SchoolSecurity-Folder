...
<head>
    ...
    <title>Device Verification - CCSS</title>
    ...
    <div class="welcome-container">
        ...
        <main class="login-choice-main fade-in">
            <div class="login-choice-card glass-panel">
                ...
                <form method="POST" action="{{ route('insideuser.device.verify.submit') }}">
                    @csrf
                ...
                <div class="login-choice-footer">
                    <form method="POST" action="{{ route('insideuser.device.verify.resend') }}" style="display: inline;">
                        @csrf
                    ...
                    <br>
                    <a href="{{ route('user.login.show') }}" class="back-link-inline" style="margin-top: 12px;">
