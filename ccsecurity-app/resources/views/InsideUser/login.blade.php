...
<head>
    ...
    <title>Students & Staff Login - CCSS</title>
    ...
    <div class="welcome-container">
        ...
        <main class="login-choice-main fade-in">
            <div class="login-choice-card glass-panel">
                ...
                <form method="POST" action="{{ route('insideuser.login.submit') }}" id="loginForm">
                    @csrf
                ...
                <div class="login-choice-footer">
                    <a href="{{ route('login.choice') }}" class="back-link-inline">
