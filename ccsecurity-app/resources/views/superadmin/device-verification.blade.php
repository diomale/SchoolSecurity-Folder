...
<head>
    ...
    <title>Device Verification - Super Admin</title>
        ...
        <main class="login-choice-main fade-in">
            <div class="login-choice-card glass-panel">
                ...
                <div class="login-choice-footer">
                    <form method="POST" action="{{ route('superadmin.device.verify.resend') }}" style="display: inline;">
                        @csrf
                    ...
                    <br>
                    <a href="{{ route('superadmin.login') }}" class="back-link-inline" style="margin-top: 12px;">
